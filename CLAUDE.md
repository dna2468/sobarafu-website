...
### 焼きそばパン（店内の焼きそばとは別物）
- **麺**: 店内とは異なる、よくある**細い蒸し麺**を使用。最初は店内と同じ林製麺の太麺で試したが、パンのふわふわ感と太麺の存在感がケンカして美味しくならなかったため、パンに合う"昔ながらの細い焼きそば"に切り替えた経緯がある。
- **構造**: **三層構造**で挟む。
  - いり卵（別で焼く）
  - たっぷりの焼きそば麺
  - キャベツ（別で炒める）
  これを老舗ベーカリー「永楽堂」のふわふわ食パンで挟む。
- **ソース**: 店内と同じソースを使うが、焼きそばパン用には**隠し味のスパイスを別途追加**している。
- **書く時の注意**:
  - 「店内と同じ太麺を挟んでいる」と書かないこと（誤り）。
  - 「店内の焼きそばとは別物」「昔ながらの焼きそば」「三層構造」「隠し味のスパイス」が訴求軸。
